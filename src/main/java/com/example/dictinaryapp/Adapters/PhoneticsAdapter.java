...
import com.example.dictinaryapp.ViewHolder.PhoneticViewHolder;
import com.example.dictinaryapp.model_.Phonetics;
...
public class PhoneticsAdapter extends RecyclerView.Adapter<PhoneticViewHolder> {
    ...
    @Override
    public PhoneticViewHolder onCreateViewHolder(@NonNull @org.jetbrains.annotations.NotNull ViewGroup parent, int viewType) {
        return new PhoneticViewHolder(LayoutInflater.from(context).inflate(R.layout.phonetic_liist_irem,parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull @org.jetbrains.annotations.NotNull PhoneticViewHolder holder, int position) {
